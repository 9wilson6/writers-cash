...
$query="SELECT * FROM delivered LEFT JOIN projects ON delivered.project_id=projects.project_id";
    ...
    <div class="display__content">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-11">
                <h1 class="headingTertiary text-light text-uppercase">Delivered Orders</h1>

                <div class="card">
                   	<div class="card-header text-uppercase">Delivered Orders</div>
                   	<div class="card-body">
