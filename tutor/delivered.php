    ...
    <div class="display__content">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-9">
                <h1 class="headingTertiary text-light">Orders Pending Clients Approval</h1>
                <div class="card">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php foreach ($results as $result): ?>
                                    ...
                                    <td class="smalll"><a href="delivered-details?pid=<?php echo urlencode(convert_uuencode($result->project_id)); ?>"><?php echo $result->project_id; ?><i
