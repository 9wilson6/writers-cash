...
<span class="input-group-text" id="username"><i class="lnr lnr-user"></i></span>
</div>
<input type="text" name="username" id="username" <?php if (isset($_SESSION['username'])): ?>
value="<?php echo $_SESSION['username'] ?>" <?php endif?> required placeholder="Username" />
</div>
</div>
<div class="col-md-6 mb-3">
...
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text" id="email"><i class="lnr lnr-envelope"></i></span>
</div>
<input type="email" name="email" <?php if (isset($_SESSION['email'])): ?>
value="<?php echo $_SESSION['email'] ?>" <?php endif?> id="email" required
placeholder="Email" />
</div>
</div>
</div>
...
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text" id="password"><i class="lnr lnr-lock"></i></span>
</div>
...
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text" id="C_password"><i class="lnr lnr-lock"></i></span>
</div>
...
<input type="number" name="pages" max="1000" id="pages" min="1" class="form-control"
...
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text" id="inputGroupPrepend2"><i class="lnr lnr-envelope"></i></span>
</div>
...
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text" id="login_password"><i class="lnr lnr-lock"></i></span>
</div>
<input type="hidden" name="user" value="student" />
<input type="hidden" name="user_type" value="1" />
<input type="hidden" name="login" value="1" />
<input type="Password" class="form-control" name="password" id="login_password"
placeholder="Password" aria-describedby="login_password" required />
</div>
</div>
<div class="row">
