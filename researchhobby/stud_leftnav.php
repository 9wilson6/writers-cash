...
<ul class="">
  ...
  <a href="./createpost"  <?php if ($page=="create") { ?>
  	class="active"
  <?php } ?>><li class="list-group-item">Post Homework</li></a>
  <a href="./classes"  <?php if ($page=="classes") { ?>
    class="active"
  <?php } ?>><li class="list-group-item">Classes</li></a>
  <a href="./my-homework" <?php if ($page=="my-homework") { ?>
   class="active"
 ...
 <a href="editing" <?php if ($page=="revision") { ?>
  ...
  <?php } ?>><li class="list-group-item"></i>Revision <span class=" " id="on_revision">0</span></li></a>
   <a href="./completed" <?php if ($page=="completed") { ?>
   class="active"
